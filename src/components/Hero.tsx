          ...
          <div className="animate-slide-in-left space-y-8">
            ...
            <div className="flex items-center gap-6 pt-4">
              ...
              <div className="flex gap-4">
                <a href="mailto:ahmadrajacpr@gmail.com" className="w-12 h-12 bg-white shadow-lg rounded-xl flex items-center justify-center text-gray-600 hover:text-blue-600 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <Mail size={20} />
                </a>
                <a href="tel:+917289095126" className="w-12 h-12 bg-white shadow-lg rounded-xl flex items-center justify-center text-gray-600 hover:text-green-600 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <Phone size={20} />
                </a>
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white shadow-lg rounded-xl flex items-center justify-center text-gray-600 hover:text-blue-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <Linkedin size={20} />
                </a>
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white shadow-lg rounded-xl flex items-center justify-center text-gray-600 hover:text-gray-900 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <Github size={20} />
                </a>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="w-80 h-80 md:w-96 md:h-96 bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 rounded-3xl p-2 shadow-2xl">
                <div className="w-full h-full rounded-2xl overflow-hidden bg-white p-2">
                  <img src="https://i.postimg.cc/7YCk2Npz/Passport-Photo.jpg" alt="Md Ahmad Raza" className="w-full h-full object-cover rounded-xl" />
                </div>
              </div>
