...
const Contact = () => {
  ...
  const SERVICE_ID = 'service_0jj46ob';
  const TEMPLATE_ID = 'template_1ypggo3';
  const PUBLIC_KEY = 'PGBugtmg-uAejjOuX';
    ...
    try {
      ...
      const result = await emailjs.send(
        ...
        TEMPLATE_ID,
        {
          ...
          to_email: 'ahmadrajacpr@gmail.com', // Your email
        },
        PUBLIC_KEY
      );
